            ...
            <ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
                ...
                <li class="active">
                    ...
                    <ul id="systemSetting" class="nav nav-list collapse secondmenu" style="height: 0px;">
                        ...
                        <li><a href="#"><i class="glyphicon glyphicon-th-list"></i>好友管理</a></li>
...
<!--                                </form>-->
                ...
                <div class="row">
                    <?php $num = -1;?>
                    <?php $img = array('/image/clannad.jpg','/image/kanon.jpg','/image/air.jpg','/image/clannad2.jpg','/image/universe.jpg');?>
                    <?php foreach ($allfriend as $friend):
                        $name = $friend['friend'];
