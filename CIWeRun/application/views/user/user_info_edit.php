            ...
            <ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
                ...
                <li class="active">
                    ...
                    <ul id="systemSetting" class="nav nav-list collapse secondmenu" style="height: 0px;">
                        <li><a href="#"><i class="glyphicon glyphicon-user"></i>信息管理</a></li>
                            ...
                            <ul class="list-group">
                                ...
                                <form class="bs-example bs-example-form" role="form">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="sex">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon">年龄:</span>
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="age">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon">生日:</span>
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="birth">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon">星座:</span>
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="star">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon">手机号:</span>
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="phone">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon">邮箱:</span>
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="email">
                                    </div>
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Twitterhandle" id="school">
                                    </div>
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">我的宣言:</span>
                                        <input type="text" class="form-control" placeholder="Twitterhandle"
                                               id="declaration">
                                    </div>
                                </form>
...
<script>
    $("#btn_submit").click(function () {
        var url = "http://localhost/CIWeRun/index.php/users/setuserinfo";
