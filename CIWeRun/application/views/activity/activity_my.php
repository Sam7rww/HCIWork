...
<head>
    <meta charset="UTF-8">
    <title>活动</title>
    <?php require_once "act_headbar.php" ?>
...
<div class="aside_div">
    ...
    <aside>
        <div class="aside_in">
            ...
            <ul class="nav nav-tabs">
                <li role="tab" class="activity_active">
                    <a href="#">我的活动</a>
                </li>
                <li role="presentation" class>
                    <a href="http://localhost/CIWeRun/index.php/activity/getMyAct">正在参加</a>
                </li>
                <li role="presentation" class>
                    <a href="http://localhost/CIWeRun/index.php/activity/getallAct">全部活动</a>
                </li>
                <li role="presentation" class>
                    <a href="http://localhost/CIWeRun/index.php/activity/gethisAct">历史活动</a>
                </li>
                                ...
                                <div class="aty-main">
                                    <form class="bs-example bs-example-form" role="form" action="activity.php">
                                        ...
                                        <div class="input-group ipt-aty ipt-aty-area">
                                            ...
                                            <h4 class="ipt-aty-h4">活动详细信息描述：</h4>
    ...
    <div class="tab-pane fade active in" id="my_aty">
        <div class="an_act ">
            <h2>活动主题:<span><?php echo $act_name; ?></span></h2>
            <div class="man">
            ...
            <div class="btn-group btn-group-lg aty-btn">
                ...
                <button type="button" class="btn btn-default">活动结束</button>
                <button type="button" class="btn btn-default">活动删除</button>
            </div>
            <div class="detail">
                <span>详细信息：</span>
                <p><?php echo $info; ?></p>
