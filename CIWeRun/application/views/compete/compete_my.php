    ...
    <aside>
        <div class="aside_in">
            ...
            <ul class="nav nav-tabs">
                ...
                <li role="presentation" class>
                    <a href="http://localhost/CIWeRun/index.php/compete/gethisCom">历史竞赛</a>
                </li>
    ...
    <div class="tab-pane fade active in" id="my_aty">
        <div class="an_act ">
            ...
            <div class="btn-group btn-group-lg aty-btn">
                ...
                <button type="button" class="btn btn-default">竞赛结束</button>
                <button type="button" class="btn btn-default">竞赛删除</button>
            </div>
            <div class="detail">
                <span>详细信息：</span>
                <p><?php echo $info; ?></p>
