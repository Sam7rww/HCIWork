...
<header>
        ...
        <div class="menu-wrap">
            <div class="menu-sidebar">
                <ul class="menu">
                    ...
                    <!--<li><a href="#">Blog</a></li>-->
                    <li class="menu-item-has-children"><a href="exercise/exercise_my.html">Run</a>
                        <span class="sidebar-menu-arrow"></span>
                        <ul class="sub-menu">
                            <li><a href="exercise/exercise_my.html">我的运动</a></li>
                    ...
                    <li class="menu-item-has-children"><a href="activity/activity_my.html">Activity</a>
                        <span class="sidebar-menu-arrow"></span>
                        <ul class="sub-menu">
                            <li><a href="activity/activity_my.html">我的活动</a></li>
                    ...
                    <li class="menu-item-has-children"><a href="compete/compete_my.html">Compete</a>
                        <span class="sidebar-menu-arrow"></span>
                        <ul class="sub-menu">
                            <li><a href="compete">我的活动</a></li>
    ...
    <div class="head_ul_div">
        <ul class="nav_bar">
            ...
            <li class="active"><a href="#">竞赛</a></li>
        </ul>
